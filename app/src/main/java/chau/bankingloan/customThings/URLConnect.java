...
public class URLConnect {
    public static String URL_UPLOAD = "http://192.168.1.13/chauvu/document.php";
    public static String PIN_GENERATE = "http://192.168.1.13/chauvu/PIN.php";
    ...
    public static String GET_LOAN_FRAG = "http://192.168.1.13/chauvu/xml/tab1.json";
}
