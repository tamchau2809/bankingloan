...
public class ConstantStuff {
    ...
    public static String FILE_UPLOAD_URL = "http://192.168.1.16/chauvu/document.php";
    public static String URL_UPLOAD = "http://192.168.1.16/chauvu/document.php";
    public static String PIN_GENERATE = "http://192.168.1.16/chauvu/PIN.php";
    public static String GET_TOOLBAR_TEXT = "http://192.168.1.16/chauvu/xml/toolbar.json";
}
